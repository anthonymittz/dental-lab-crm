...
function Options() {
  return (
    <div className="flex gap-2 flex-row justify-end items-center h-full">
      <Button size="sm" type="secondary"><Icon type="fileDown" className="text-c-600" /></Button>
      <Button size="sm" type="secondary"><Icon type="fileUp" className="text-c-600" /></Button>
